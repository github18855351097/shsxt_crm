...
<div id="p" class="easyui-panel" style="width: 700px;height: 350px;padding: 10px">
    ...
    <table cellspacing="8px">
        ...
        <tr>
            <td>请求内容：</td>
            <td><input type="text" id="serviceRequest" name="serviceRequest" class="easyui-validatebox"
        ...
        <tr>
            <td><a class="easyui-linkbutton" href="javascript:saveCustomerServe()" iconCls="icon-save"
                   plain="true">提交</a></td>
